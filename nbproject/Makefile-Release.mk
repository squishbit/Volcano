...
${OBJECTDIR}/BlackCaps.o: BlackCaps.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BlackCaps.o BlackCaps.cpp

${OBJECTDIR}/GridReference.o: GridReference.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GridReference.o GridReference.cpp

${OBJECTDIR}/Minimax.o: Minimax.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Minimax.o Minimax.cpp
...
${OBJECTDIR}/VolcanoBoard.o: VolcanoBoard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VolcanoBoard.o VolcanoBoard.cpp
...
${TESTDIR}/tests/BlackCapTest.o: tests/BlackCapTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BlackCapTest.o tests/BlackCapTest.cpp


${TESTDIR}/tests/bctestrunner.o: tests/bctestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bctestrunner.o tests/bctestrunner.cpp


${TESTDIR}/tests/GridReferenceTest.o: tests/GridReferenceTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GridReferenceTest.o tests/GridReferenceTest.cpp


${TESTDIR}/tests/grtestrunner.o: tests/grtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/grtestrunner.o tests/grtestrunner.cpp


${TESTDIR}/tests/PyramidTest.o: tests/PyramidTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PyramidTest.o tests/PyramidTest.cpp


${TESTDIR}/tests/pytestrunner.o: tests/pytestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/pytestrunner.o tests/pytestrunner.cpp


${TESTDIR}/tests/VolcanoBoardTest.o: tests/VolcanoBoardTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/VolcanoBoardTest.o tests/VolcanoBoardTest.cpp


${TESTDIR}/tests/vbtestrunner.o: tests/vbtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/vbtestrunner.o tests/vbtestrunner.cpp
...
${OBJECTDIR}/BlackCaps_nomain.o: ${OBJECTDIR}/BlackCaps.o BlackCaps.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BlackCaps_nomain.o BlackCaps.cpp;\
	else  \
...
${OBJECTDIR}/GridReference_nomain.o: ${OBJECTDIR}/GridReference.o GridReference.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GridReference_nomain.o GridReference.cpp;\
	else  \
...
${OBJECTDIR}/Minimax_nomain.o: ${OBJECTDIR}/Minimax.o Minimax.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Minimax_nomain.o Minimax.cpp;\
	else  \
...
${OBJECTDIR}/Pyramid_nomain.o: ${OBJECTDIR}/Pyramid.o Pyramid.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pyramid_nomain.o Pyramid.cpp;\
	else  \
...
${OBJECTDIR}/VolcanoBoard_nomain.o: ${OBJECTDIR}/VolcanoBoard.o VolcanoBoard.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VolcanoBoard_nomain.o VolcanoBoard.cpp;\
	else  \
